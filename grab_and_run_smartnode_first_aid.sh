...
bash /tmp/smartnode_first_aid/smartnode_first_aid.sh | tee /tmp/smartnode_health_check/smartnode_first_aid.txt

echo "Smartnode First Aid Report : /tmp/smartnode_health_check/smartnode_first_aid_report.txt"
echo
